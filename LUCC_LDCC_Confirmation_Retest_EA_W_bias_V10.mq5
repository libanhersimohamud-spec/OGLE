//+------------------------------------------------------------------+
//|              LUCC_LDCC_Confirmation_Retest_EA_V10.mq5            |
//|                                                                    |
//| Expert Advisor port of "LUCC / LDCC Confirmation & Retest         |
//| Indicator" (Pine v6).                                              |
//|                                                                    |
//| ==== V10 CHANGE — ENTRY TIMEFRAME 2H -> 1H ====================== |
//| The ONLY difference from V9 is the entry timeframe: V10 uses 1H    |
//| entries instead of 2H (ENTRY_TF = PERIOD_H1). This is the          |
//| controlled 1H twin of V9 for a like-for-like 1H-vs-2H comparison;  |
//| all six engines, bias/confirmation logic, pattern detection, trade |
//| management, targets, stops, partial/BE/lock, CSV logging, stats,   |
//| and optimization inputs are byte-for-byte identical to V9.         |
//|                                                                    |
...
//======================================================================
// ENTRY TIMEFRAME. All entry-signal detection (LUCC/LDCC, CC, RC), the
// new-bar trigger, pending-order / expiration logic, and every entry-candle
// count run on this timeframe. Nothing else (Weekly/2W/5D/10D bias,
// Daily/2D confirmation, trade management, targets, stops, partial/BE/lock,
// CSV structure, stats) depends on it.
// ENTRY_TF_SECS mirrors ENTRY_TF in seconds for entry-candle bar counts.
//   V8/V9 use H2 (7200); V10 is the controlled 1H twin: H1 (3600).
//======================================================================
